...
//       // Update news list locally without refetching all
//       set(state => ({ news: [res.data, ...state.news], loading: false }));
//     } catch (error) {
//       set({ error: error.response?.data?.message || "Failed to create news", loading: false });
//       throw error;
//     }
//   },
...
//       set(state => ({
//         news: state.news.map((item) => (item._id === id ? res.data : item)),
//         loading: false,
//       }));
//     } catch (error) {
//       set({ error: error.response?.data?.message || "Failed to update news", loading: false });
//       throw error;
//     }
//   },
...
//       }));
//     } catch (error) {
//       set({ error: error.response?.data?.message || "Failed to delete news", loading: false });
//       throw error;
//     }
//   },
// }));
...
export const useNewsStore = create((set) => ({
  ...
  fetchNews: async () => {
    ...
    try {
      const res = await api.get("/news");
      console.log("Fetched news from API:", res.data); // Debug
