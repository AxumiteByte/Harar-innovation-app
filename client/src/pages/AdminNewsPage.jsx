...
//   // Reset editing state & refresh news list after create/update
...
//   return (
//     <div className="max-w-5xl mx-auto p-6 bg-[#253864] rounded-2xl border border-[#253864] shadow-lg mt-8 text-gray-200">
//       <h1 className="text-3xl font-bold text-[#FFA500] mb-6 text-center">
